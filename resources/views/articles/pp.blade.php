        ...
        <section class="py-5 text-center container">
          <div class="row py-lg-5">
            <div class="col-lg-6 col-md-8 mx-auto">
              <h1 class="fw-light"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">PRODUITS PP</font></font></h1>
              <p class="lead text-muted"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Les produits en polypropylène (PP): <br> &nbsp;  sont largement utilisés dans diverses industries en raison de leurs excellentes propriétés. Le polypropylène est un polymère thermoplastique qui se distingue par sa résistance chimique, sa légèreté, sa résistance à la chaleur et à la déformation, ainsi que sa polyvalence.</font></font></p>
