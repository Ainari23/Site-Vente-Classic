        ...
        <section class="py-5 text-center container">
          <div class="row py-lg-5">
            <div class="col-lg-6 col-md-8 mx-auto">
              <h1 class="fw-light"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">PRODUITS PEHD</font></font></h1>
              <p class="lead text-muted"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">Les produits en PEHD (polyéthylène haute densité): <br> &nbsp; sont largement utilisés dans diverses industries en raison de leurs propriétés spécifiques. Le PEHD est un type de plastique thermoplastique réputé pour sa résistance, sa durabilité, sa résistance chimique et sa polyvalence.</font></font></p>
              <select class="form-select" aria-label="Default select example">
                <option selected>Utilisation</option>
                <option value="1">Emballage</option>
                <option value="2">Tuyauterie et conduites d'eau</option>
                <option value="3">Emballage industriel</option>
                <option value="'4'">Bacs de stockage</option>
                <option value="5">Revêtements</option>
                <option value="6">Géomembranes</option>
                <option value="7">Contenants pour aliments et boissons</option>
                <option value="8">Produits de plein air</option>
                <option value="9">Fabrication de pièces industrielles</option>
                <option value="10">Recyclage</option>
              </select>
            </div>
          </div>
        </section>
